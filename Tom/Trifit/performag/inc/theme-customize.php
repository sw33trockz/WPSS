...
class MyTheme_Customize {
	...
	public static function register( $wp_customize ) {
		...
		$wp_customize->add_setting( 'thrivetheme_menu_link_color', array(
			'default'           => $default_values['thrivetheme_menu_link_color'],
			'type'              => 'theme_mod',
			'sanitize_callback' => 'sanitize_hex_color',
			'capability'        => 'edit_theme_options',
		) );
		...
		//header search
		$wp_customize->add_setting( 'thrivetheme_header_search', array(
			'default'    => 'block',
			'type'       => 'theme_mod',
			'capability' => 'edit_theme_options',
		) );
		$wp_customize->add_control( 'thrivetheme_header_search', array(
			'priority' => 1,
			'label'    => __( 'Header Search Field', 'thrive' ),
			'section'  => 'thrivetheme_header',
			'settings' => 'thrivetheme_header_search',
			'type'     => 'radio',
			'choices'  => array(
				'block' => __( 'On', 'thrive' ),
				'none'  => __( 'Off', 'thrive' )
	...
	public static function header_output() {
		...
		<style type="text/css">.wp-video-shortcode {
			...
			self::generate_css( '.twr', 'background', 'background_color', '' );
			...
			self::generate_css( '.bSe h1, .bt .entry-title', 'color', 'thrivetheme_headline_color', '' );
			...
			self::generate_css( '.bSe h1, .bt  .entry-title', 'font-family', 'thrivetheme_header_font', '' );
			...
			self::generate_css( '.bSe h1, .bt  .entry-title', 'font-weight', 'thrivetheme_headline_weight', '' );
			...
			self::generate_css( '.bSe h1, .bt .entry-title, .ind .entry-title', 'font-size', 'thrivetheme_header_fontsize', '', 'px' );
			...
			self::generate_css( 'header a#logo > img', 'max-width', 'thrivetheme_logo_image_width', '', 'px' );
			self::generate_css( 'header .hf', 'display', 'thrivetheme_header_search', '' );
			?></style>
		<?php
	}

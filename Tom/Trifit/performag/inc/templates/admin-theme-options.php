...
<div class="option_tabs left">
	<div class="thrive-admin-submenu">
		...
		<a id="thrive-magazine-features"
		   rel="magazine-features-options"><?php _e( "Magazine Features", 'thrive' ); ?></a>
		<a id="thrive-homepage-layout" rel="homepage-layout-options"><?php _e( "Homepage Layout", 'thrive' ); ?></a>
		<div class="clear"></div>
	</div>
</div>
	...
	<form action="options.php" id="thrive-options-form" method="post">
		<div class="options-container">
			<div id="thrive-admin-container">
				...
				<div class="thrive-admin-subcontainer" id="thrive-admin-subcontainer-magazine-features-options">
					<?php
					settings_fields( 'thrive_options' );
					do_settings_sections( 'theme_magazine_options' );
					?>
				</div>
				<!--Homepage Layout options-->
				<div class="thrive-admin-subcontainer" id="thrive-admin-subcontainer-homepage-layout-options">
					<h3><?php _e( 'Homepage Layout', 'thrive' ); ?></h3>
					<?php do_settings_sections( 'theme_magazine_home_options' ); ?>
					<?php require_once 'admin-home-layout.php'; ?>
					<input type="hidden" name="thrive_theme_options[homepage_layout_settings]"
					       id="thrive_options_hidden_homepage_layout_settings" value=""/>
				</div>
			</div>
		</div>

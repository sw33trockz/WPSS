...
?>
            ...
            <input type="hidden" name="thrive_meta_postformat_gallery_images" value="<?php echo $thrive_meta_postformat_gallery_images; ?>" id="thrive_meta_postformat_gallery_images" />
            <input type="button" id="btn_thrive_post_format_select_gallery" value="<?php _e( "Select images", 'thrive' ) ?>" />
        </td>
    </tr>
</table>
-->
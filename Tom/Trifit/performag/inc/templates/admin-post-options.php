<div class="option_tabs left">
	<div class="thrive-admin-submenu">
		...
		<a id="thrive-link-thrive-ads" rel="thrive-ads"><?php _e( "Thrive Ads", 'thrive' ); ?></a>
		<div class="clear"></div>
	</div>
</div>
		...
		<div id="thrive-admin-container">
			<div class="thrive-admin-subcontainer" id="thrive-admin-subcontainer-general-options">
				<table class="form-table postEdit">
						...
						<td>
							<select id='thrive_post_template' name='thrive_meta_post_template'>
								<?php foreach ( $post_templates as $tpl_name ): ?>
									<option
										value='<?php echo $tpl_name; ?>' <?php echo ( $tpl_name == $value_post_template ) ? "selected" : ""; ?> ><?php echo $tpl_name; ?></option>
								<?php endforeach ?>
							</select>
						</td>
					</tr>
					...
					<?php if ( thrive_get_theme_options( "related_posts_box" ) == 1 || thrive_get_theme_options( "enable_infinite_scroll_single" ) === "on" ): ?>
						<tr>
							<th scope="row">
						...
						<td>
							...
							<select name='thrive_meta_post_focus_area_top_select'>
								...
								foreach ( $queryFocusAreas->get_posts() as $p ):
									if ( _thrive_check_focus_area_template_position( $p->ID, "top" ) ):
										?>
					...
					<tr>
						...
						<td>
							...
							<select name='thrive_meta_post_focus_area_bottom_select'>
								<?php
								foreach ( $queryFocusAreas->get_posts() as $p ):
									if ( _thrive_check_focus_area_template_position( $p->ID, "bottom" ) ):
										?>
										<option value='<?php echo $p->ID ?>'
				...
				<table class="form-table postEdit">
					...
					<tr>
						...
						<td>
							...
							<input type="button" class="thrive-select-image thrive_options pure-button upload"
			...
			<div class="thrive-admin-subcontainer" id="thrive-admin-subcontainer-thrive-ads">
				<table class="form-table postEdit">
					<tr>
						<th scope="row">

...
class Thrive_Related_Widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		<section class="recent-posts" id="<?php echo $this->id; ?>">
			<div class="scn">
				<div class="twr">
						...
						<li>
							<?php if ( isset( $instance['display_thumbnails'] ) && $instance['display_thumbnails'] == 1 ): ?>
								<?php if ( isset( $post['image'] ) && $post['image'] ): ?>
									<div class="rpw" style="background-image: url('<?php echo $post['image']; ?>')"><a
											href="<?php echo $post['url']; ?>"></a></div>
								<?php endif; ?>
							<?php endif; ?>
	...
	function _get_featured_image( $postId ) {
		...
		$featured_image_data = thrive_get_post_featured_image( $postId, "tt_related_widget" );

...
jQuery(document).ready(function () {
    ...
    jQuery(".tt-chk-social-display-location").click(ThriveThemeOptions.set_social_display_location_value);
    ...
    jQuery("#tt-submit-button").click(function (event) {
        ...
        //build the home layout options object
        jQuery("#thrive_options_hidden_homepage_layout_settings").val(JSON.stringify(ThriveHomeLayout.build_options_obj()));
    ...
    jQuery('#post_date_on').click(ThriveThemeOptions.show_post_date_settings);
    jQuery('#post_date_off').click(ThriveThemeOptions.hide_post_date_settings);
    if (jQuery('#post_date_on:checked').length > 0) {
        ThriveThemeOptions.show_post_date_settings();
    } else if (jQuery('#post_date_off:checked').length > 0) {
        ThriveThemeOptions.hide_post_date_settings();
    }
...
ThriveThemeOptions.set_social_display_location_value = function () {
    ...
    jQuery(".tt-chk-social-display-location").each(function () {
...
ThriveThemeOptions.show_post_date_settings = function () {
    jQuery('input[name="thrive_theme_options[meta_post_date_type]"]').parents('tr').show();
}

ThriveThemeOptions.hide_post_date_settings = function () {
    jQuery('input[name="thrive_theme_options[meta_post_date_type]"]').parents('tr').hide();
}

...
ThriveFocusOptions.display_fields = {
    ...
    template3: ["container-focus-template", "container-focus-color", "container-heading-text", "container-subheading-text", "container-button-text",
        "container-focus-image", "container-button-link", "container-new-tab"],
    template4: ["container-focus-template", "container-focus-color", "container-heading-text", "container-subheading-text", "container-button-color",
        "container-focus-image", "postdivrich", "container-optin", "container-button-text"],
...
ThriveFocusOptions.hide_fields = {
    ...
    template4: ["container-button-link", "container-new-tab", "container-focus-image", "container-custom-text"],
...
ThriveFocusOptions.display_template_fields = function (template) {
    ...
    ThriveFocusOptions.restrict_position();
};
...
ThriveFocusOptions.restrict_position = function () {
    var _currentTemplate = jQuery("#thrive_focus_template").val().toLowerCase();
    var _selectedPosition = jQuery("#thrive_meta_focus_display_location").val();
    if (_currentTemplate == "template1" || _currentTemplate == "template2") {
        jQuery("#thrive_meta_focus_display_location option[value='top']").removeAttr("disabled");
        jQuery("#thrive_meta_focus_display_location option[value='bottom']").prop("disabled", "disabled");
        jQuery("#thrive_meta_focus_display_location option[value='between_posts']").prop("disabled", "disabled");
        jQuery("#thrive_meta_focus_display_location").val("top");
    } else {
        jQuery("#thrive_meta_focus_display_location option[value='top']").prop("disabled", "disabled");
        jQuery("#thrive_meta_focus_display_location option[value='bottom']").removeAttr("disabled");
        jQuery("#thrive_meta_focus_display_location option[value='between_posts']").removeAttr("disabled");
        if (_selectedPosition == "top") {
            jQuery("#thrive_meta_focus_display_location").val("bottom");
        }
    }
};

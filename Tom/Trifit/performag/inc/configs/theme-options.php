...
function thrive_get_default_customizer_options( $color_scheme = null ) {
	...
	switch ( $color_scheme ) {
		case 'green':
			$default_values = array(
				'thrivetheme_link_color'      => '#668a1d',
				'thrivetheme_highlight_color' => '#668a1d',
				'thrivetheme_headline_color'  => '#000000',
				'thrivetheme_bodytext_color'  => '#333',
				'thrivetheme_header_font'     => '//fonts.googleapis.com/css?family=Lato:400,300,700&subset=latin,latin-ext',
				'thrivetheme_body_font'       => '//fonts.googleapis.com/css?family=Lato:400,300,700&subset=latin,latin-ext',
				'thrivetheme_header_fontsize' => '50',
		...
		case 'red':
			$default_values = array(
				'thrivetheme_link_color'      => '#993333',
				'thrivetheme_highlight_color' => '#993333',
				'thrivetheme_headline_color'  => '#000000',
				'thrivetheme_bodytext_color'  => '#333',
				'thrivetheme_header_font'     => '//fonts.googleapis.com/css?family=Lato:400,300,700&subset=latin,latin-ext',
				'thrivetheme_body_font'       => '//fonts.googleapis.com/css?family=Lato:400,300,700&subset=latin,latin-ext',
		...
		case 'blue':
			$default_values = array(
				'thrivetheme_link_color'      => '#2e7da4',
				'thrivetheme_highlight_color' => '#2e7da4',
				'thrivetheme_headline_color'  => '#000000',
				'thrivetheme_bodytext_color'  => '#333',
				'thrivetheme_header_font'     => '//fonts.googleapis.com/css?family=Lato:400,300,700&subset=latin,latin-ext',
				'thrivetheme_body_font'       => '//fonts.googleapis.com/css?family=Lato:400,300,700&subset=latin,latin-ext',
		...
		case 'orange':
			$default_values = array(
				'thrivetheme_link_color'      => '#cc9900',
				'thrivetheme_highlight_color' => '#cc9900',
				'thrivetheme_headline_color'  => '#000000',
				'thrivetheme_bodytext_color'  => '#333',
				'thrivetheme_header_font'     => '//fonts.googleapis.com/css?family=Lato:400,300,700&subset=latin,latin-ext',
				'thrivetheme_body_font'       => '//fonts.googleapis.com/css?family=Lato:400,300,700&subset=latin,latin-ext',
		...
		case 'purple':
			$default_values = array(
				'thrivetheme_link_color'      => '#5a597c',
				'thrivetheme_highlight_color' => '#5a597c',
				'thrivetheme_headline_color'  => '#000000',
				'thrivetheme_bodytext_color'  => '#333',
				'thrivetheme_header_font'     => '//fonts.googleapis.com/css?family=Lato:400,300,700&subset=latin,latin-ext',
				'thrivetheme_body_font'       => '//fonts.googleapis.com/css?family=Lato:400,300,700&subset=latin,latin-ext',
		...
		case 'teal':
			$default_values = array(
				'thrivetheme_link_color'      => '#289595',
				'thrivetheme_highlight_color' => '#289595',
				'thrivetheme_headline_color'  => '#000000',
				'thrivetheme_bodytext_color'  => '#333',
				'thrivetheme_header_font'     => '//fonts.googleapis.com/css?family=Lato:400,300,700&subset=latin,latin-ext',
				'thrivetheme_body_font'       => '//fonts.googleapis.com/css?family=Lato:400,300,700&subset=latin,latin-ext',
	...
	$default_values['thrivetheme_menu_highlight_color'] = "";
	$default_values['thrivetheme_theme_background']     = "default-header";

	$color_theme = thrive_get_theme_options( 'color_theme' );

	if ( $color_theme == "dark" ) {
		$default_values['thrivetheme_menu_link_color'] = "#FFFFFF";
	} else {
		$default_values['thrivetheme_menu_link_color'] = "#333";
	}
...
function thrive_get_default_theme_options() {
	...
	$default_theme_options = array(
		...
		'enable_infinite_scroll'        => "off",
		'enable_infinite_scroll_single' => "off",
		'enable_home_custom_layout'     => "off",
		'enable_share_buttons_on_blog'  => "on",
		'blog_layout'                   => "default",
		'color_theme'                   => "light",
		'social_site_title'             => "",
...
function thrive_get_options_for_post( $postId = null ) {
	...
	if ( is_single() ) {
		if ( isset( $post_options['_thrive_meta_post_meta_info'][0] ) && $post_options['_thrive_meta_post_meta_info'][0] == 'off' ) {
			$display_options['meta_author_name']   = '';
			$display_options['meta_post_date']     = '';
			$display_options['meta_post_category'] = '';
			$display_options['meta_post_tags']     = '';
		}
	}
	...
	if ( isset( $post_options['_thrive_meta_post_related_box'][0] ) && $post_options['_thrive_meta_post_related_box'][0] == "off" && ( is_single() || is_page() ) ) {
		...
		$display_options['enable_infinite_scroll_single'] = 0;
	}

	$current_post_type = get_post_type();
	if ( $current_post_type == "thrive_slideshow" ) {
...
function thrive_set_default_customizer_options( $color_scheme = null, $resetOnlyColors = false, $resetColorScheme = false ) {
	if ( $color_scheme === null ) {
		$color_scheme = thrive_get_theme_options( 'color_scheme' );
	}

	if ( $resetColorScheme == false ) {
		$default_options = thrive_get_default_customizer_options( $color_scheme );
	} else {
		//when we reset the scheme color scheme, we change only the menu link color
	...
	if ( $resetColorScheme ) {
		if ( $color_scheme == "dark" ) {
			set_theme_mod( 'thrivetheme_menu_link_color', "#FFFFFF" );
		} else {
			set_theme_mod( 'thrivetheme_menu_link_color', "#333" );
		}
	}

	//set other default values
	if ( ! $resetOnlyColors && ! $resetColorScheme ) {

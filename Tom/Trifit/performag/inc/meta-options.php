...
function thrive_add_custom_fields() {
	...
	add_meta_box( 'thrive_post_options', __( 'Thrive Theme Options', 'thrive' ), 'thrive_meta_post_options', "thrive_slideshow" );
...
function thrive_meta_page_options( $page ) {
	...
	//add meta values
	$value_ad_group_header      = get_post_meta( $page->ID, '_thrive_ad_group_header', true );
	$value_ad_group_beginning   = get_post_meta( $page->ID, '_thrive_ad_group_beginning', true );
	$value_ad_group_end_of_post = get_post_meta( $page->ID, '_thrive_ad_group_end_of_post', true );
...
function thrive_save_postdata( $post_id ) {
	...
	} elseif ( 'post' == $_POST['post_type'] || 'thrive_slideshow' == $_POST['post_type'] ) {
...
function _thrive_save_post_options( $post_data ) {
	...
	if ( ! isset( $post_data['thrive_meta_show_post_title'] ) ) {
		return;
	}
	...
	$thrive_meta_post_related_box        = isset( $post_data['thrive_meta_post_related_box'] ) ? $post_data['thrive_meta_post_related_box'] : "";
...
function _thrive_save_page_options( $post_data ) {
	...
	add_post_meta( $page_ID, '_thrive_ad_group_header', $thrive_ad_group_header, true ) or
	update_post_meta( $page_ID, '_thrive_ad_group_header', $thrive_ad_group_header );

	add_post_meta( $page_ID, '_thrive_ad_group_beginning', $thrive_ad_group_beginning, true ) or
	update_post_meta( $page_ID, '_thrive_ad_group_beginning', $thrive_ad_group_beginning );

	add_post_meta( $page_ID, '_thrive_ad_group_end_of_post', $thrive_ad_group_end_of_post, true ) or
	update_post_meta( $page_ID, '_thrive_ad_group_end_of_post', $thrive_ad_group_end_of_post );
}
